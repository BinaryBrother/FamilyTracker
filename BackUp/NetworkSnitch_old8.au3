...
AdlibRegister("_Fill_ARP_Table", 1000 * 60 * 5) ; (Default: 5 minutes) This will determine how often we scan the network for devices.
...
Func _GetARPTable()
	If $bGet_ARP_Table_FirstRun Then 
		_Fill_ARP_Table()
	endif
